...
<nav class="navbar navbar-light bg-light bg-primary fixed-top flex-md-nowrap p-50">
        <a class="navbar-brand col-sm-3 col-md-2 mr-0 text-nowrap" href="#" id="dash" style="color: green">Farmers Profile</a>
        ...
        <div class="row">
            <div class="col-md-2 bg-dark d-none d-md-block sidebar shadow">
                ...
                <ul class="nav flex-column sidebar-nav">
                    ...
                    <li class="nav-item ">
                        <a class="nav-link pl-10" href="farmers_dash_body.php">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="farmers_dash_profile.php" style="color: green">
                ...
                <div class="row" id="main">
                    <div class="col-md-4 well" id="leftPanel">
                        <div class="row">
                            <div class="col-md-12">
                                <div>
                                    <img src="./img/prof1.jpg" width="250" height="auto" alt="Texto Alternativo" class="img-circle img-thumbnail" style="border-radius: 10em; margin-top: 15px">
