            ...
            <div class="row-fluid" style="background-color: white; min-height: 600px; padding:10px;">
                ...
                <div class="widget-box">
                    ...
                    <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="1st Paragraph" name="firsttag1"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">First Slide 2nd Tag :</label>
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="2nd Paragraph" name="firsttag2"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="1st Paragraph" name="secondtag1"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Second Slide 2nd Tag :</label>
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="2nd Paragraph" name="secondtag2"/>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="1st Paragraph" name="thirdtag1"/>
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">Third Slide 2nd Tag :</label>
                            <div class="controls">
                                <input type="text" class="form-control span11" placeholder="2nd Paragraph" name="thirdtag2"/>
                            </div>
                        </div>
